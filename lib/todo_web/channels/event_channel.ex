defmodule TodoWeb.EventChannel do
  use TodoWeb, :channel
  ...
  def broadcast_create(model) do
    ...
    TodoWeb.Endpoint.broadcast("event:lobby", "new", data)
  end
  ...
  def broadcast_update(%{data: model, changes: changes} = _changeset) do
    ...
    TodoWeb.Endpoint.broadcast("event:lobby", "change", data)
  end
  ...
  def broadcast_destroy(model) do
    ...
    TodoWeb.Endpoint.broadcast("event:lobby", "delete", data)
  end
